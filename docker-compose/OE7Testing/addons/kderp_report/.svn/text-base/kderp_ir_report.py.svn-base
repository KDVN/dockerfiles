...
class report_xml(osv.osv):
    ...
    _columns = {
                ...
                'jasper_output': fields.selection([('html','HTML'),('csv','CSV'),('xls','XLS'),('rtf','RTF'),('odt','ODT'),('ods','ODS'),('txt','Text'),('pdf','PDF'),('docx','Microsoft Office Word (docx)'),('xlsx','Microsoft Office Excel (xlsx)')], 'Jasper Output'),
                }
    _defaults = {
